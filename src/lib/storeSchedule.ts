export type StoreMode="auto"|"force_open"|"force_closed";
...
export type StoreSettings={mode:StoreMode;timezone:string;schedule:Record<DayKey,DaySchedule>;exceptions:StoreException[]};
...
export const DEFAULT_STORE_SETTINGS:StoreSettings={mode:"auto",timezone:"America/Sao_Paulo",schedule:{
 ...
 sat:{enabled:true,open:"18:00",close:"23:15"}},exceptions:[]};
...
export function normalizeStoreSettings(raw:unknown):StoreSettings{
 ...
 const mode: StoreMode = o.mode==="force_open"||o.mode==="force_closed"||o.mode==="auto"?o.mode:(typeof o.isOpen==="boolean"?(o.isOpen?"force_open":"force_closed"):"auto");
 return{mode,timezone:typeof o.timezone==="string"&&o.timezone?o.timezone:DEFAULT_STORE_SETTINGS.timezone,schedule,exceptions};
}
