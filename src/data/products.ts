...
export const products: Product[] = [
...

  {
    ...
    price: 59.99,
    oldPrice: 82.00,
    image: "/img/combo-familia-uai.png",
    category: "promocoes",
    disponivel: true,
    isSuggestion: false,
    promoPlacement: "home_showcase",
